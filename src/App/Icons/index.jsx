...
const Sun = props => {
    const { icon, primary, secondary, fillPrimary, fillSecondary } = props;
    return (
        <svg 
            xmlns="http://www.w3.org/2000/svg" 
            className={`icon ${icon || styles.sun_icon}`}
            viewBox="0 0 640 512">
            <path 
                className={`${!fillPrimary && (primary || styles.sun_primary)}`}
                fill={`${!!fillPrimary && fillPrimary}`}
            ...
            <path 
                className={`${!fillSecondary && (secondary || styles.sun_secondary)}`}
                fill={`${!!fillSecondary && fillSecondary}`}
...
const Moon = props => {
    ...
    return (
        <svg 
            xmlns="http://www.w3.org/2000/svg" 
            className={`icon ${icon || styles.moon_icon}`}
            viewBox="0 0 576 512">
            <path 
                className={`${!fillPrimary && (primary || styles.moon_primary)}`}
                fill={`${!!fillPrimary && fillPrimary}`}
            ...
            <path 
                className={`${!fillSecondary && (secondary || styles.moon_secondary)}`}
                fill={`${!!fillSecondary && fillSecondary}`}
