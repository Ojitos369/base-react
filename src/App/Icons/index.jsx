...
const Sun = props => {
    ...
    return (
        <svg 
            ...
            viewBox="0 0 640 512">
            <path 
                className={`${primary || styles.sun_primary}`}
            ...
            <path 
                className={`${secondary || styles.sun_secondary}`}
...
const Moon = props => {
    ...
    return (
        <svg 
            ...
            viewBox="0 0 576 512">
            <path 
                className={`${primary || styles.moon_primary}`}
            ...
            <path 
                className={`${secondary || styles.moon_secondary}`}
